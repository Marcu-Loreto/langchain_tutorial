...
## riar a classe que vai receber a saida estruturada 
...
## gora preciso criar um modelo que vai usar esta saida estruturada, um modelo customizado

model_customizado = model_openai.with_structured_output(RespostaUsuario)

## Agra posso usar o modelo customizado para fazer uma chamada
resposta_customizada = model_customizado.invoke("ola, aqui é o joao, sabe qual a capital do Brasil?")


## Como definir uma lista especifica de respostas para mostra na tela
...
## omo adicionar MEMORIA ao modelo ?
